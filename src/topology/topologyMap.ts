...
export const TOPOLOGY_MAP = {
  ...
  vismon: {
    ...
    aiContentWindow: { x: 0.6816, y: 0.1149, w: 0.3096, h: 0.1559 } satisfies NormalizedRect,
    energyContentWindow: { x: 0.6816, y: 0.4040, w: 0.3096, h: 0.1559 } satisfies NormalizedRect,
  },
  markerSizes: {
