...
export const TOPOLOGY_MAP = {
  ...
  vismon: {
    ...
    aiContentWindow: { x: 0.6971, y: 0.0624, w: 0.2791, h: 0.2188 } satisfies NormalizedRect,
    energyContentWindow: { x: 0.6971, y: 0.4054, w: 0.2791, h: 0.2117 } satisfies NormalizedRect,
  },
  markerSizes: {
