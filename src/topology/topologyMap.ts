...
export const TOPOLOGY_MAP = {
  ...
  vismon: {
    ...
    aiContentWindow: { x: 0.6957, y: 0.1415, w: 0.2687, h: 0.1413 } satisfies NormalizedRect,
    energyContentWindow: { x: 0.6984, y: 0.4319, w: 0.2687, h: 0.1413 } satisfies NormalizedRect,
  },
  markerSizes: {
